...
<a class="btn btn-info" href="{{action('EmployeeCheck@edit',$employee->emp_id)}}"> Update</a>
<a class="btn btn-warning" href="{{action('EmployeeCheck@show',$employee->emp_id)}}"> Show</a>
<a class="btn btn-danger" href="{{action('EmployeeCheck@destroy',$employee->emp_id)}}"> Delete</a>
